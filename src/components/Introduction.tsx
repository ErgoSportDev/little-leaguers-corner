          ...
          <div className="grid md:grid-cols-3 gap-8">
            {teachers.map((teacher, index) => (
              <motion.div
                ...
                className={index === 3 ? "md:col-start-2 flex flex-col items-center text-center p-6 rounded-lg shadow-lg bg-white/60 backdrop-blur-sm" : "flex flex-col items-center text-center p-6 rounded-lg shadow-lg bg-white/60 backdrop-blur-sm" }
              >
